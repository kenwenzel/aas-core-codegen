...
_A relationship element is used to define a relationship between two elements being either referable (model reference) or external (global reference)._





URI: [aas:RelationshipElement](https://admin-shell.io/aas/3/0/RC02/RelationshipElement)
...
```mermaid
 classDiagram
    ...
    click RelationshipElement href "../RelationshipElement/"
      ...
      RelationshipElement : category
        
      RelationshipElement : checksum
        
      RelationshipElement : description
        
      RelationshipElement : displayName
      ...
      RelationshipElement : embeddedDataSpecifications
        ...
        RelationshipElement --> "*" EmbeddedDataSpecification : embeddedDataSpecifications
      ...
      RelationshipElement : extensions
        ...
        RelationshipElement --> "*" Extension : extensions
      ...
      RelationshipElement : first
        ...
        RelationshipElement --> "1" Reference : first
        click Reference href "../Reference/"
    

        
      RelationshipElement : idShort
        
      RelationshipElement : kind
        
          
    
        
        
        RelationshipElement --> "0..1" ModelingKind : kind
        click ModelingKind href "../ModelingKind/"
    

        
      RelationshipElement : qualifiers
        
          
    
        
        
        RelationshipElement --> "*" Qualifier : qualifiers
      ...
      RelationshipElement : second
        ...
        RelationshipElement --> "1" Reference : second
        click Reference href "../Reference/"
    

        
      RelationshipElement : semanticId
        
          
    
        
        
        RelationshipElement --> "0..1" Reference : semanticId
        click Reference href "../Reference/"
    

        
      RelationshipElement : supplementalSemanticIds
        
          
    
        
        
        RelationshipElement --> "*" Reference : supplementalSemanticIds
        click Reference href "../Reference/"
...
* [SubmodelElement](SubmodelElement.md) [ [Referable](Referable.md) [HasKind](HasKind.md) [HasSemantics](HasSemantics.md) [Qualifiable](Qualifiable.md) [HasDataSpecification](HasDataSpecification.md)]
    * **RelationshipElement**
        * [AnnotatedRelationshipElement](AnnotatedRelationshipElement.md)
...
| ---  | --- | --- | --- |
| [first](first.md) | 1 <br/> [Reference](Reference.md) | Reference to the first element in the relationship taking the role of the sub... | direct |
| [second](second.md) | 1 <br/> [Reference](Reference.md) | Reference to the second element in the relationship taking the role of the ob... | direct |
...
| ---  | ---  |
| self | aas:RelationshipElement |
| native | aas:RelationshipElement |
...
description: A relationship element is used to define a relationship between two elements
