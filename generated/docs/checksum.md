...
_Checksum to be used to determine if an Referable (including its aggregated child elements) has changed._





URI: [aas:checksum](https://admin-shell.io/aas/3/0/RC02/checksum)
Alias: checksum
