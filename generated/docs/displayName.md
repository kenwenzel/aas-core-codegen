...
_Display name. Can be provided in several languages._





URI: [aas:displayName](https://admin-shell.io/aas/3/0/RC02/displayName)
Alias: displayName
...
| ---  | ---  |
| self | aas:displayName |
| native | aas:displayName |
