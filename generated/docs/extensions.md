...
_An extension of the element._





URI: [aas:extensions](https://admin-shell.io/aas/3/0/RC02/extensions)
Alias: extensions
...
| [HasExtensions](HasExtensions.md) | Element that can be extended by proprietary extensions |  no  |
