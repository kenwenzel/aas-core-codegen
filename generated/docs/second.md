...
_Reference to the second element in the relationship taking the role of the object._





URI: [aas:second](https://admin-shell.io/aas/3/0/RC02/second)
Alias: second
...
```yaml
name: second
description: Reference to the second element in the relationship taking the role of
  the object.
