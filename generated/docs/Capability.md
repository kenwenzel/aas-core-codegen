...
_A capability is the implementation-independent description of the potential of an asset to achieve a certain effect in the physical or virtual world._





URI: [aas:Capability](https://admin-shell.io/aas/3/0/RC02/Capability)
...
```mermaid
 classDiagram
    ...
    click Capability href "../Capability/"
      ...
      Capability : embeddedDataSpecifications
        
          
    
        
        
        Capability --> "*" EmbeddedDataSpecification : embeddedDataSpecifications
      ...
      Capability : kind
        ...
        Capability --> "0..1" ModelingKind : kind
      ...
      Capability : qualifiers
        ...
        Capability --> "*" Qualifier : qualifiers
      ...
      Capability : semanticId
        ...
        Capability --> "0..1" Reference : semanticId
      ...
      Capability : supplementalSemanticIds
        ...
        Capability --> "*" Reference : supplementalSemanticIds
        click Reference href "../Reference/"
...
```yaml
name: Capability
description: A capability is the implementation-independent description of the potential
