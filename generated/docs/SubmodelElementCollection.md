...
_A submodel element collection is a kind of struct, i.e. a a logical encapsulation of multiple named values. It has a fixed number of submodel elements._





URI: [aas:SubmodelElementCollection](https://admin-shell.io/aas/3/0/RC02/SubmodelElementCollection)
...
```mermaid
 classDiagram
    ...
    click SubmodelElementCollection href "../SubmodelElementCollection/"
      ...
      SubmodelElementCollection : category
        
      SubmodelElementCollection : checksum
        
      SubmodelElementCollection : description
        
      SubmodelElementCollection : displayName
        
      SubmodelElementCollection : embeddedDataSpecifications
        
          
    
        
        
        SubmodelElementCollection --> "*" EmbeddedDataSpecification : embeddedDataSpecifications
        click EmbeddedDataSpecification href "../EmbeddedDataSpecification/"
    

        
      SubmodelElementCollection : extensions
        
          
    
        
        
        SubmodelElementCollection --> "*" Extension : extensions
        click Extension href "../Extension/"
    

        
      SubmodelElementCollection : idShort
        
      SubmodelElementCollection : kind
        
          
    
        
        
        SubmodelElementCollection --> "0..1" ModelingKind : kind
        click ModelingKind href "../ModelingKind/"
    

        
      SubmodelElementCollection : qualifiers
        
          
    
        
        
        SubmodelElementCollection --> "*" Qualifier : qualifiers
        click Qualifier href "../Qualifier/"
    

        
      SubmodelElementCollection : semanticId
        
          
    
        
        
        SubmodelElementCollection --> "0..1" Reference : semanticId
      ...
      SubmodelElementCollection : supplementalSemanticIds
        ...
        SubmodelElementCollection --> "*" Reference : supplementalSemanticIds
        click Reference href "../Reference/"
      ...
      SubmodelElementCollection : value
        ...
        SubmodelElementCollection --> "*" SubmodelElement : value
        click SubmodelElement href "../SubmodelElement/"
...
| ---  | --- | --- | --- |
| [value](value.md) | * <br/> [SubmodelElement](SubmodelElement.md) | Submodel element contained in the collection | direct |
...
| ---  | ---  |
| self | aas:SubmodelElementCollection |
| native | aas:SubmodelElementCollection |
...
description: A submodel element collection is a kind of struct, i.e. a a logical encapsulation
...
attributes:
  value:
    ...
    from_schema: https://admin-shell.io/aas/3/0/RC02
    alias: value
    owner: SubmodelElementCollection
    domain_of:
    - Blob
    - DataSpecificationIec61360
    - Extension
